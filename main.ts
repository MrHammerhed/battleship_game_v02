...
function Norfolk () {
    ...
    if (roll == 1) {
        ...
        if (E_Field[I6] == 0) {
            I6 = position_x + 5 * position_y
            i4 = i4 + 1
            Norfolk_X = position_x
            Norfolk_Y = position_y
        }
    }
    if (roll == 0) {
        if (E_Field[I6] != 0) {
...
function Prince_of_Wales () {
    I6 = position_x + 5 * position_y
    if (roll == 1) {
        if (E_Field[I6] != 0 || E_Field[I6 + 5] != 0) {
            Free_B = 0
            position_x = 0
            position_y = 0
            i4 = 0
        ...
        if (E_Field[I6] == 0 || E_Field[I6 + 5] == 0) {
            for (let index = 0; index < 2; index++) {
                I6 = position_x + 5 * position_y
                i4 = i4 + 1
                Prince_of_Wales_X1 = position_x
                Prince_of_Wales_X2 = position_x
                if (i4 == 1) {
                    Prince_of_Wales_Y1 = position_y
                }
                if (i4 == 2) {
                    Prince_of_Wales_Y2 = position_y
                }
                position_y = position_y + 1
            }
        }
    ...
    if (roll == 0) {
        if (E_Field[I6] != 0 || E_Field[I6 + 1] != 0) {
            Free_B = 0
            position_x = 0
            position_y = 0
            i4 = 0
...
function Bismarck () {
    for (let index = 0; index < 3; index++) {
        ...
        i4 = i4 + 1
        if (roll == 1) {
            Bismarck_X1 = position_x
            Bismarck_X2 = position_x
            Bismarck_X3 = position_x
            if (i4 == 1) {
                Bismarck_Y1 = position_y
            }
            if (i4 == 2) {
                Bismarck_Y2 = position_y
            }
            if (i4 == 3) {
                Bismarck_Y3 = position_y
            }
...
// 3
function Prinz_Eugen () {
    I6 = position_x + 5 * position_y
    if (roll == 1) {
        if (P_Field[I6] != 0 || P_Field[I6 + 5] != 0) {
            Free_B = 0
            position_x = 0
            position_y = 0
            i4 = 0
        ...
        if (P_Field[I6] == 0 || P_Field[I6 + 5] == 0) {
            for (let index = 0; index < 2; index++) {
                I6 = position_x + 5 * position_y
                i4 = i4 + 1
                Prinz_Eugen_X1 = position_x
                Prinz_Eugen_X2 = position_x
                if (i4 == 1) {
                    Prinz_Eugen_Y1 = position_y
                }
                if (i4 == 2) {
                    Prinz_Eugen_Y2 = position_y
                }
                led.plot(position_x, position_y)
                position_y = position_y + 1
            }
    ...
    if (roll == 0) {
        if (P_Field[I6] != 0 || P_Field[I6 + 1] != 0) {
            Free_B = 0
            position_x = 0
            position_y = 0
            i4 = 0
...
basic.forever(function () {
    ...
    if (P_Ships == 0) {
        Chapter = 5
        basic.showString("Yoy Lose")
    }
    if (E_Ships == 0) {
        Chapter = 5
        basic.showString("Yoy Win")
    }
    if (Chapter == 5) {
        if (input.buttonIsPressed(Button.A)) {
            basic.pause(5000)
